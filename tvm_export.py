...
torch.onnx.export(model, torch.randn(1, 1, 28, 28), f"{dirname}/tvm_out/model.onnx")
...
target = tvm.target.Target("llvm -device=arm_cpu -model=bcm2835 -mtriple=aarch64-linux-gnu -mcpu=cortex-a72 -mattr=+neon")
